...
var require_polyfills = __commonJS({
  "node_modules/graceful-fs/polyfills.js"(exports, module) {
    var constants = (init_constants(), __toCommonJS(constants_exports));
    ...
    if (!fs[gracefulQueue]) {
      ...
      if (/\bgfs4\b/i.test(process.env.NODE_DEBUG || "")) {
        process.on("exit", function() {
          ...
          (init_assert(), __toCommonJS(assert_exports)).equal(fs[gracefulQueue].length, 0);
        });
      }
    }
    var queue;
...
// dep:@roxi_routify__fs-extra
var roxi_routify_fs_extra_default = require_lib();
export {
  roxi_routify_fs_extra_default as default
};
//# sourceMappingURL=@roxi_routify__fs-extra.js.map
