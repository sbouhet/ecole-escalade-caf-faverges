    ...
    {:else}
        ...
        {:else}
            ...
            <small style="color:grey">
                ...
                <a href="mailto:escaladefaverges74@gmail.com?subject=[Ecolde d'escalade] Demande de dérogation {$currentDay.weekday} {$currentDay.startTime}" target="_new">escaladefaverges74@gmail.com</a>
                </i>
            </small>
            <br><br>
        {/if}
